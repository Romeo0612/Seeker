...
export class ApiService {
  ...
  private baseUrl: string = 'http://10.0.0.122:7000/';
  // private baseUrl: string = 'http://10.0.0.122:7071/';
  // private baseUrl: string = 'http://10.0.0.122:9071/';

  // private baseUrl: string = 'http://192.168.1.28:7000/';
  public getWsBaseUrl() {
    return `http://10.0.0.122:7000/`
    // return `http://192.168.1.28:7000/`
    // return 'http://10.0.0.122:9071/'
    // return 'http://10.0.0.122:8071/'
...
getfilterjob(data:any){
 ...
 getDataList(collectionName:any) {
  ...
  finalfileUpload(data: any,id:any) {
    ...
    return this.http.post(this.getWsBaseUrl()+`uploads/${id}`, data);
  }
