...
@NgModule({
  declarations: [
    ActionButtonComponent1,ActionButtonComponent,ActionButtonComponent2
    ,JobsComponent,CandidatesComponent,PostedjobsComponent,UserprofileComponent,EventComponent, DashboardComponent,
  ],
  imports: [
